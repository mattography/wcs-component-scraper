        ...
        <Toolbar>
          ...
          <ButtonGroup variant="solid" aria-label="outlined button group">
            <Tooltip title="Show All">
              <Button onClick={() => setA11yType("")}>
                <ListIcon />
              </Button>
            </Tooltip>
            <Tooltip title="Ready">
              <Button onClick={() => setA11yType("a11y-ready")}>
                <WarningAmber style={{ color: "#D63B25" }} />
              </Button>
            </Tooltip>
            <Tooltip title="Unknown">
              <Button onClick={() => setA11yType("a11y-unknown")}>
                <QuestionMarkIcon style={{ color: "#e58e01" }} />
              </Button>
            </Tooltip>
            <Tooltip title="True">
              <Button onClick={() => setA11yType("a11y-true")}>
                <CheckCircleOutline style={{ color: "#009a09" }} />
              </Button>
            </Tooltip>
          </ButtonGroup>
          <Search>
