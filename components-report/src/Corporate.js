...
function Corporate(props) {
  ...
  const getData=()=>{
    setIsLoading(true);
    fetch('./cleanedCorporateIds.json')
    ...
    <div>
      ...
      {isLoading ? (<div className="loading"><p>Loading components...</p><div className="loader"></div></div>):(
          ...
          <div className="components-details">
            <p>Data last updated: 7/28/2022</p> <Tooltip title="Download Corporate components CSV"><Link href="#" underline="none" id="download-link" onClick={() => saveToCSV(rows)} download="wcs-corporate-components.csv"><span>Download CSV</span><Download/></Link></Tooltip>
          </div>
