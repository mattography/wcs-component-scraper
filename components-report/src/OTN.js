    ...
    <div>
      ...
      {isLoading ? (<div className="loading"><p>Loading components...</p><div className="loader"></div></div>):(
          ...
          <div className="components-details">
            <p>Data last updated: 11/22/2022</p> <Tooltip title="Download OTN components CSV"><Link href="#" underline="none" id="download-link" onClick={() => saveToCSV(rows)} download="wcs-otn-components.csv"><span>Download CSV</span><Download/></Link></Tooltip>
          </div>
